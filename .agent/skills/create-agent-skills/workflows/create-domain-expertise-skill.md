...
Explain:
```
Domain expertise skills go in: ~/.antigravity/skills/expertise/{domain-name}/
...
Location: ~/.antigravity/skills/expertise/{suggested-name}/
```
...
mcp_context7_query-docs: {library-id}
```
...
```bash
# Create structure
mkdir -p ~/.antigravity/skills/expertise/{domain-name}
mkdir -p ~/.antigravity/skills/expertise/{domain-name}/workflows
mkdir -p ~/.antigravity/skills/expertise/{domain-name}/references
...
# Verify structure
ls -R ~/.antigravity/skills/expertise/{domain-name}
```

## Step 11: Document in create-plans

Update `~/.antigravity/skills/create-plans/SKILL.md` to reference this new domain:
...
- [ ] Platform-specific considerations included
- [ ] Located in ~/.antigravity/skills/expertise/{domain-name}/
