...
# If complex:
mkdir -p ~/.antigravity/skills/{skill-name}/workflows
mkdir -p ~/.antigravity/skills/{skill-name}/references
# If needed:
mkdir -p ~/.antigravity/skills/{skill-name}/templates  # for output structures
mkdir -p ~/.antigravity/skills/{skill-name}/scripts    # for reusable code
```
...
```bash
cat > ~/.antigravity/commands/{skill-name}.md << 'EOF'
---
