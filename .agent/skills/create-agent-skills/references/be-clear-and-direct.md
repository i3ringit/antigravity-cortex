<golden_rule>
Show your skill to someone with minimal context and ask them to follow the instructions. If they're confused, Antigravity will likely be too.
</golden_rule>
...
Give Antigravity contextual information that frames the task:
...
Context helps Antigravity make better decisions and produce more appropriate outputs.
...
<specificity>
Be specific about what you want Antigravity to do. If you want code only and nothing else, say so.
...
Sequential steps create clear expectations and reduce the chance Antigravity skips important operations.
</sequential_steps>
</guidelines>
...
The unclear version leaves all these decisions to Antigravity, increasing the chance of misalignment with expectations.
</key_differences>
...
Antigravity learns patterns from examples more reliably than from descriptions.
</why_showing_works>
</show_dont_just_tell>
...
❌ **"Consider..."** - Should Antigravity always do this or only sometimes?
...
<define_edge_cases>
<principle>
Anticipate edge cases and define how to handle them. Don't leave Antigravity guessing.
</principle>
...
<decision_criteria>
<principle>
When Antigravity must make decisions, provide clear criteria.
</principle>
...
**Benefits**: Antigravity has objective criteria for making the decision rather than guessing.
</with_criteria>
</decision_criteria>
...
<success_criteria>
<principle>
Define what success looks like. How will Antigravity know it succeeded?
</principle>
...
If a human with minimal context struggles, Antigravity will too.
</testing_process>
</testing_clarity>
